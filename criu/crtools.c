...
"  --membarrier-register-expedited do membarrier(MEMBARRIER_CMD_REGISTER_PRIVATE_EXPEDITED)\n"
"                        Useful when restoring apps that creates registration since CRIU\n"
"                        does not track it\n"
"  --mmap-pages          Forces to mmap checkpointed pages in COW mode from the image files\n"
"  					     instead of restoring them into memory. Useful to share the memory\n"
"                        between multiple instances of restored processes.\n"
