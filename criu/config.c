...
#define BOOL_OPT(OPT_NAME, SAVE_TO) \
	...
	static struct option long_opts[] = {
		...
		BOOL_OPT("membarrier-register-expedited", &opts.membarrier_register_expedited),
		BOOL_OPT("mmap-pages", &opts.mmap_pages),
		BOOL_OPT("ignore-unknown-fd-mounts", &opts.ignore_fd_unknown_mounts),
